...
const UUIDS = [
    ,  82a68d01-744b-416c-9275-de24b68b4287
    ,  3e5ede00-182e-42d7-88bf-c0a166fa217d
    , 1775b282-e05c-43f2-a5ce-02005157fc42
    ,80acce12-8d3c-4933-9d2a-d853a8aea1ee
    ,c4c5fe8b-3dc1-40fd-aaa7-305accd03c3d
];

// 订阅地址后缀（这里需要修改一下，可以随便输入一些字母或数字）
const SUB_PATH = 'ziy8u7gwhusg3';

// XHTTP 路径（这里需要修改一下，可以随便输入一些字母或数字）
const XPATH = 'dgh7yh3w4h33';
